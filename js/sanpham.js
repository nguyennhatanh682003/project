class Sanpham {
    ...
    themSanpham(arr) {
        ...
        for (let i = 0; i < arr.length; i++) {
            rowProducts.append("<a class='product' href='../html/chitietsanpham.html'><div><div class='productImg'><img src='" + arr[i].hinhanh[0] + "' alt=''></div><h3 class='productTen'>" + arr[i].ten + "</h3><div class='productGia'>" + arr[i].gia + "<sup>đ</sup></div><div class='productThemGioHang'><span>Thêm sản phẩm vào giỏ hàng</span></div></div></a>")
